...
from commands.drive.direct.swerve_to_point import SwerveToPoint
from commands.drive.direct.go_to_point import GoToPoint
...
class SwerveTrajectory(JerkyTrajectory):
    ...
    def initialize(self):
        ...
        config = TrajectoryConfig(
            AutoConstants.kMaxMetersPerSecond * abs(self.speed),
            AutoConstants.kMaxAccelerationMetersPerSecondSquared,
        )
        # Add kinematics to ensure max speed is actually obeyed
        config.setKinematics(DrivingConstants.kDriveKinematics)
